...
# for counting the number of copies of each TEST_HAPLOTYPE (joined to the INCLUDED_HAPLOTYPE) and fitting the corresponding logistic model in DRIVE
...
PHENOTYPES=$1 # phenotypes file for getting age ("ageonset"), principal components of ancestry ("pc1" to "pc10") and affected status ("BCa") from each subject ("sid")
