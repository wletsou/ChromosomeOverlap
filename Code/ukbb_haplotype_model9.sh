...
test -f ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt && echo rm ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt
test -f ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt && rm ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt && printf "\n"
echo touch ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt
touch ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt && printf "\n"
...
do
  ...
  if ((i==${RANGE[0]}))
  then
    echo mv ${NAME}new_allele_counts.haplotype_${i}.txt ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt && printf "\n"
    mv ${NAME}new_allele_counts.haplotype_${i}.txt ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt
  else
    # concatenate new column to haplotypes count table
    echo awk \'BEGIN{OFS=\"\\t\"} NR==FNR{seen[\$1]=\$2\; next} \(\$1 in seen\){print \$0,seen[\$1]}\' ${NAME}new_allele_counts.haplotype_${i}.txt ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt \> ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").tmp
    awk 'BEGIN{OFS="\t"} NR==FNR{seen[$1]=$2; next} ($1 in seen){print $0,seen[$1]}' ${NAME}new_allele_counts.haplotype_${i}.txt ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt > ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").tmp && printf "\n"

    test -f ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").tmp && echo mv ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").tmp ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt
    test -f ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").tmp && mv ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").tmp ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt && printf "\n"
  fi
...
if [ ! -f ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt ]
then
  echo No output produced for \(${RANGE[0]},${RANGE[1]}\).
  echo awk \'NR==1{print \"sid\"} NR\>1{seen[\$1]+=1\; printf \"%s_%s\\n\",\$1,seen[\$1]}\' ${POPULATION} \> ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt
  awk 'NR==1{print "sid"} NR>1{seen[$1]+=1; printf "%s_%s\n",$1,seen[$1]}' ${POPULATION} > ${NAME}new_allele_counts.$(eval "printf '%0${char_h}d-%0${char_h}d' ${RANGE[0]} ${RANGE[1]}").txt && printf "\n"
fi
