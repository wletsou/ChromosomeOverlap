#! /bin/bash
#Look for lines in TEST_FILE not in REF_FILE and write to OUT.INDEX, where INDEX indicates the comparison job index when dividing the comparison job into groups of DELTA lines in the TEST_FILE
