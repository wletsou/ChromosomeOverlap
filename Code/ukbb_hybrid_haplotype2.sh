...
# bsub -P SJLIFE -J ukbb_hybrid_haplotype2.chr11.1809006-2009006 -oo ukbb_hybrid_haplotype2.chr11.1809006-2009006.out -eo ukbb_hybrid_haplotype2.chr11.1809006-2009006.err -R "rusage[mem=10000]" "sh /home/wletsou/scripts/ukbb_hybrid_haplotype2.sh ukbb_bca_cases.indiv,ukbb_bca_controls.indiv 11 1809006,2009006 /research/rgs01/project_space/yasuigrp/EpiGenetics/common/yasuigrp_data/biobank/gds/ukb.bca.hap/ukb.bca.hap.chr11.new.vcf.gz"
...
echo Remove SNPs that are not monoallelic:
