...
# usage: Rscript index2combo2.R I=index n=total sigma=2 allow.repeats=FALSE
...
Ind_array <- array(I,dim=c(1,sigma+1)) # initiate an array of the linear positions of the multi-index in sigma, sigma-1, ..., 1 dimensional arrays
...
cat(multiindex[,2:(sigma+1)],fill = TRUE) # print the tuple, starting from 0, corresponding to the multi-index 1,2,...,sigma # nolint
